            ...
            <div className="container-fluid border rounded bg-success" style={{ width: "auto", margin: "50px", padding: "10px" }}>
                <form onSubmit={handleAddFunction}>
                    <div className="container-fluid w-50">
                        <label className="form-label float-start text-white fw-bolder" style={{ textShadow: "2px 2px 4px black" }} typeof="text">Product Id:</label><br />
                        <input className="form-control" placeholder="Enter the ID"  type="text" onChange={(e) => setPId(e.target.value)} />
                    </div>
                    <div className="container-fluid w-50">
                    ...
                    <div className="container-fluid w-50">
                        ...
                        <input className="form-control"  placeholder="Enter the Price" type="number"  onChange={(e) => setPprice(e.target.value)} />
                    </div>
                    <div className="container-fluid w-50">
