...
const SingleProduct = () => {
    ...
    if (!requestComplete) {
        ...
        design = (
            <>
                <div className="container-fluid bg-success border rounded" style={{
                    display: "flex",
                    ...
                    <div className="table-responsive" style={{ width: "400px", height: "auto", margin: "180px" }} >
                        <table className="table table-bordered rounded" style={{ border: "2px solid black" }}>
                            <tr className="text-end my-2">
                                <th className="text-end w-25 p-2">DETAIL:</th>
                                <td className="text-start w-50 p-2 text-white ">{product.product_name}</td>
                            </tr>
                            <tr className="my-1">
                            ...
                            <tr className="my-2">
                                ...
                                <td className="text-start w-50 p-2 text-white" >{product.product_code}</td>
                            </tr>
                            <tr className="my-2">
                                <th className="text-end w-25 p-2">DESCRIPTION:</th>
                                <td className="text-start w-50 p-2 text-white">{product.description}</td>
                            </tr>
                            <tr className="my-2">
                                <th className="text-end w-25 p-2">AVAILABILITY:</th>
                                <td className="text-start w-50 p-2 text-white">{product.release_date}</td>
                            </tr>
                            <tr className="my-2">
                                <th className="text-end w-25 p-2">PRICE:</th>
                                <td className="text-start w-50 p-2 text-white">{product.price}</td>
                            </tr>
                            <tr className="my-2">
                                <th className="text-end w-25 p-2">RATING:</th>
                                <td className="text-start w-50 p-2 text-white">{product.star_rating}</td>
                            </tr>
                            <tr className="my-2">
                                <td className="p-2">
                                    <Link to="/" className="p-0">
                                        <button className="btn btn-dark " type="button">Back</button>
                                    </Link>
                                </td>
                                <td className=" p-2">
