        ...
        design = (
            <>
                <div className="float-start m-2 p-10 bg-dark rounded text-light">
                    ...
                    <label className="mx-2 my-1 text-uppercase " typeof="text">Filter By: </label>
                    <select className="form-select my-1 mx-2 rounded bg-secondary text-white" style={{ width: "180px", height: "35px" }} onChange={selectHandler}>
                                    ...
                                    (e) => {
                                        return (
                                            <tr key={e.product_id}>
                                                ...
                                                <td>{e.price}</td>
                                                <td>{e.star_rating}</td>
                                                <td><DeleteProduct productId={e.product_id} /></td>
                                            </tr>
                                        )
                                    }
                                )
